...
<<<<<<< HEAD
            ...
            {
                existingProfile = new TransparentClock.PrepMeter.PrepProfile
                {
                    TargetExam = "JEE Advanced",
                    TargetDate = new DateTime(DateTime.Now.Year + 1, 5, 25),
                    StartDate = DateTime.Today,
                    Subjects = new System.Collections.Generic.List<string> { "Physics", "Chemistry", "Mathematics" }
                };
                TransparentClock.PrepMeter.PrepMeterStorage.SaveProfile(existingProfile);
            }
...
<<<<<<< HEAD
            ...
            profileGenderComboBox = new ComboBox { DropDownStyle = ComboBoxStyle.DropDownList, Width = 250 };
            ...
            // Advanced Prep Fields
            var examLabel = new Label { Text = "Target Exam (e.g. JEE, NEET)", AutoSize = true, Margin = new Padding(0, 6, 0, 2) };
            var examTextBox = new TextBox { Text = existingProfile.TargetExam, Width = 250 };

            var targetDateLabel = new Label { Text = "Target Exam Date", AutoSize = true, Margin = new Padding(0, 6, 0, 2) };
            var targetDatePicker = new DateTimePicker { Value = existingProfile.TargetDate > new DateTime(2000, 1, 1) ? existingProfile.TargetDate : DateTime.Today.AddYears(1), Width = 250, Format = DateTimePickerFormat.Short };

            var startDateLabel = new Label { Text = "Preparation Start Date", AutoSize = true, Margin = new Padding(0, 6, 0, 2) };
            var startDatePicker = new DateTimePicker { Value = existingProfile.StartDate > new DateTime(2000, 1, 1) ? existingProfile.StartDate : DateTime.Today, Width = 250, Format = DateTimePickerFormat.Short };
...
<<<<<<< HEAD
            ...
            saveProfileButton = new Button { Text = "Save Configuration", AutoSize = true, BackColor = Color.FromArgb(0, 123, 255), ForeColor = Color.White, FlatStyle = FlatStyle.Flat };
            ...
            deleteDataButton = new Button { Text = "Delete Data", AutoSize = true, Margin = new Padding(6, 0, 0, 0), BackColor = Color.FromArgb(220, 90, 90), ForeColor = Color.White, FlatStyle = FlatStyle.Flat };
            ...
            saveProfileButton.Click += (_, __) =>
            {
                ...
                // Save Prep Meter Settings dynamically!
                var updatedProfile = new TransparentClock.PrepMeter.PrepProfile
                {
                    TargetExam = examTextBox.Text.Trim(),
                    TargetDate = targetDatePicker.Value,
                    StartDate = startDatePicker.Value,
                    Subjects = subjectsTextBox.Text.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries).Select(s => s.Trim()).ToList()
                };
                TransparentClock.PrepMeter.PrepMeterStorage.SaveProfile(updatedProfile);
...
<<<<<<< HEAD
            ...
            profileLayout.Controls.Add(targetDatePicker, 1, 4);
            profileLayout.Controls.Add(startDateLabel, 0, 5);
            profileLayout.Controls.Add(startDatePicker, 1, 5);
...
<<<<<<< HEAD
           ...
           // Case 2: Agar user ne [X] dabaya aur "Minimize to Tray" OFF hai
            if (!allowClose && !Program.CurrentState.MinimizeToTrayOnClose)
            {
                Program.ExitApplication();
=======
